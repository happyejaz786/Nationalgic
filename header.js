            ...
            <div class="footer-container" style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; max-width: 1200px; margin: 0 auto; padding: 0 15px; flex-wrap: wrap;">
                ...
                <div class="hit-counter" style="background: rgba(255,255,255,0.1); padding: 5px 10px; border-radius: 5px; display: flex; align-items: center;">
					...
					<!-- hitwebcounter Code START -->
						<img src="https://www.hitwebcounter.com/counter/counter.php?page=21505320&amp;style=0010&amp;nbdigits=5&amp;type=ip" alt="https://www.hitwebcounter.com/age-calculator" decoding="async" style="border:0;max-width:100%;height:auto;" />
						<br />
						<a href="https://www.hitwebcounter.com/" target="_blank" rel="noopener" style="font-family:sans-serif, Arial, Helvetica;font-size:9px;color:#6D6C72;text-decoration:none;font-weight:bold;"></a>
